                        ...
                        <div class="panel-body">
                            ...
                            @can('editRoles', $dataTypeContent)
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="dinas" name="dinas">
                                        <option value="" selected disabled>None</option>
                                        @foreach (\App\Models\Dinas::all() as $dinas)
                                            <option value="{{ $dinas->id }}"
                                            @if(isset($dataTypeContent->id))
                                                {{ ($dinas->id == $dataTypeContent->dinas_id ? 'selected' : '') }}
                                                    @endif
                                            >{{ $dinas->nm_dinas }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                {{-- ./Dinas --}}
